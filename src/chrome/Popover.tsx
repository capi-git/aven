...
export function Popover({
  ...
  useEffect(() => {
    ...
    const onWindowBlur = (event: FocusEvent) => {
      // Clicks in a native child webview never bubble through this document.
      // Losing window focus is outside dismissal, without reclaiming focus.
      if (event.target === event.currentTarget) dismissRef.current?.("outside");
    };
